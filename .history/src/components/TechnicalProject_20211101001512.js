...
import Pic1 from "../Pics/MovieScreenshot1.png"
...
function TechnicalProject () {
    return (
        <div className="technical-project-container" background-image={Pic1}>
            ...
            <div className="technical-projects">
                ...
                <div className="Bikini-Bottom-Adventures">
                    ...
                    <div className="gitHub-Link">
                        <a href="https://github.com/nj10deadend/Game-prototype" target="_blank">
                            <img width={20} height={20} src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" alt="Github" /> 
                        </a>
                        <Typography variant="p" component="div" gutterBottom>
                            Github: <a href="https://github.com/nj10deadend/Game-prototype" target="_blank">code</a>
                        </Typography>
