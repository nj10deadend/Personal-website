...
{/* 
                ...
                <a href="https://www.twitch.tv/deadend_digital" target="_blank">
                    <img className="socials-icons" width={20} height={20} src="https://blog.twitch.tv/assets/uploads/03-glitch.jpg" alt="Twitch" />
                </a>

                <a href="https://www.instagram.com/nj10_deadend/" target="_blank">
                    <img className="socials-icons" width={20} height={20} src="https://www.howtogeek.com/wp-content/uploads/2021/08/instagram_hero_1200_675.png?width=1198&trim=1,1&bg-color=000&pad=1,1" alt="Instagram" />
                </a>
