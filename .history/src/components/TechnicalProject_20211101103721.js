            ...
            <div className="technical-projects">
                <div className="Dusk">
                    ...
                    <div className="gitHub-Link">
                        <a href="https://github.com/nj10deadend/phase-5-project" target="_blank" rel="noreferrer">
                            <img width={20} height={20} src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" alt="Github" /> 
                        </a>
                        <Typography variant="p" component="div" gutterBottom>
                            Github: <a href="https://github.com/nj10deadend/phase-5-project" target="_blank" rel="noreferrer">code</a>
                        </Typography>
                ...
                {/* <hr></hr> */}
                <div className="Bikini-Bottom-Adventures">
                    <Typography variant="h4" component="div" gutterBottom>
                    ...
                    <div className="gitHub-Link">
                        <a href="https://github.com/nj10deadend/Game-prototype" target="_blank" rel="noreferrer">
                            <img width={20} height={20} src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" alt="Github" /> 
                        </a>
                        <Typography variant="p" component="div" gutterBottom>
                            Github: <a href="https://github.com/nj10deadend/Game-prototype" target="_blank" rel="noreferrer">code</a>
                        </Typography>
